...
// Referencing Azure.Functions.OpenApi + this single call contributes the
// GET /api/openapi.json and GET /api/openapi.yaml endpoints.
builder.Services.AddOpenApi(options =>
{
    options.Title = "Sample Function App";
    options.Version = "1.0.0";
    options.Description = "Demonstrates Azure.Functions.OpenApi in an isolated worker v4 app.";
});
